...
namespace WpfDiary.Models.Converters
{
     public static class StudentConverter
    {
        public static StudentWrapper ToWrapper(this Student model)
        {
            return new StudentWrapper
            {
                ...
                Math = string.Join(" , ", model.Ratings.
                        ...
                        .Select(y => y.Rate)), // w ten sposób konwerujemy liste ocen z matamatyki na string
        ...
        public static List<Rating> toRatingDao(this StudentWrapper model)
        {
            ...
            //Przekonwertowanie stringow na listę w tym wypadku oceny na liste obiektow rating
